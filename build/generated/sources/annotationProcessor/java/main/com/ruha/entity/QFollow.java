...
public class QFollow extends EntityPathBase<Follow> {
    ...
    private static final long serialVersionUID = 364941783L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QFollow follow = new QFollow("follow");

    public final DateTimePath<java.time.LocalDateTime> followedAt = createDateTime("followedAt", java.time.LocalDateTime.class);
